namespace ReadingPdf.Library
{
    public class LPaginador<T>
    {
        ...
        private readonly int pagi_nav_num_enlaces = 3;
        private int pagi_actual;
        //definimos qué irá en el enlace a la página anterior 
        private readonly String pagi_nav_anterior = " &laquo; Anterior ";
        //definimos qué irá en el enlace a la página siguiente 
        private readonly String pagi_nav_siguiente = " Siguiente &raquo; ";
        //definimos qué irá en el enlace a la página siguiente 
        private readonly String pagi_nav_primera = " &laquo; Primero ";
        private readonly String pagi_nav_ultima = " Último &raquo; ";
