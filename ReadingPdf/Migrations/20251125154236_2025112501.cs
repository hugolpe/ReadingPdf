...
{
    /// <inheritdoc />
    public partial class _2025112501 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "EmpresasReconocidas",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TextoOriginal = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FechaRegistro = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmpresasReconocidas", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pasajero = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TipoDocumento = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Notas = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Empresa = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CuentaPredicha = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ScorePrediccion = table.Column<int>(type: "int", nullable: false),
                    EnrichedIndustry = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnrichedSubIndustry = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnrichedSector = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnrichedNaics = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnrichedTags = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnrichedCompanyDomain = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CuentaContableAplicada = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
